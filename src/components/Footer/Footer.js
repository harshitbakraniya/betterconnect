      ...
      <div className='content d-flex justify-content-between'>
        <div className='left'>
          ...
          <div className='links-icons d-flex'>
            ...
            <button className='btn'><AiFillInstagram /></button>
          </div>
        </div>
        <div className='right'>
          <div className='contact-detail'>
            <span className='email'><MdOutlineMail />info@betterconnect.in</span>
            <span className='mobile'><IoMdCall />8103546038</span>
          </div>
        </div>
      </div>
      <div className='bottom-bar d-flex justify-content-between'>
        <div className='left'>
          <span className='copy-right'>Copyright @2023 BetterConnect All Rights Reserverd</span>
        </div>
        <div className='right'>
